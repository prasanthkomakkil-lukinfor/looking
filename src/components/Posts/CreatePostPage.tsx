  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 text-center max-w-sm w-full">
    ...
    <div className="w-full px-3 py-4 sm:px-6 sm:py-6 md:px-8">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-xl p-3 mb-4 flex gap-2 items-center">
          ...
          <p className="text-xs sm:text-sm text-teal-800">You approve who contacts you. No spam.</p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 space-y-4 shadow-sm"
        >
          <div>
